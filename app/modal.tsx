...
import { editUserLang, setUserToken } from "@/actions/user";
...
export default function ModalScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Image
          source={require("@/assets/icons/uzbek-lang.png")}
          width={32}
          height={32}
      ...
      >
        <Image
          source={require("@/assets/icons/english-lang.png")}
          width={32}
          height={32}
          style={styles.language_image}
        />
      ...
      >
        <Image
          source={require("@/assets/icons/russian-lang.png")}
          width={32}
          height={32}
          style={styles.language_image}
        />
